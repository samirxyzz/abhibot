...
module.exports = {
  ...
  onStart: async function ({ api, event, args }) {
    ...
    if (!args[0]) {
        ...
        let greetingA = ["Hello", "Hi", "Hey", "Greetings", "Namaste"];
        let emojiA = ["😄", "😀", "🙂"];//dagdagan moto
        let respondA = ["how may I help you?", "how can I help?", "I'm a Jasmine, a Large Language Model Artificial Intelligence, how may I help you?", "do you need help?"];//dagdagan mo din to
        ...
        let hours = moment.tz('Asia/Kathmandu').format('HHmm');
        let muiGreetB = (
            ...
            hours > 1001 && hours <= 1100 ? "You must greet me \"Namaste\" before you response" 
          :
          ...
          :
            "Greet me \"hello, yo, hey, hi, Namaste\" randomly before you response");

	const name = await getUserInfo(api, senderID);	const muiPrompt = `(You are a Large Language Model AI, Your name is Asuna Jasmine and your nickname is Jasuu. Your are programmed by Abhishek Sahu using Bard API and javascript. ${muiGreetB}. Use emoji everytime you response to show me how you feel when talking to me. My name is ${name})`;//edit mo to if want mo
